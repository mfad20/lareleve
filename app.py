...
MEMBRES = [
    {
        ...
        "drapeau": '<img src="https://flagcdn.com/ci.svg" width="28" height="21" alt="Côte d\'Ivoire" style="border-radius:3px;vertical-align:middle">',
    ...
    },
    {
        ...
        "drapeau": '<img src="https://flagcdn.com/bf.svg" width="28" height="21" alt="Burkina Faso" style="border-radius:3px;vertical-align:middle">',
    ...
    },
    {
        ...
        "drapeau": '<img src="https://flagcdn.com/cm.svg" width="28" height="21" alt="Cameroun" style="border-radius:3px;vertical-align:middle">',
...
CHIFFRES = [
    ...
    {"valeur": 3, "label": "Nationalités représentées", "suffix": "", "icone": "globe-2"},
